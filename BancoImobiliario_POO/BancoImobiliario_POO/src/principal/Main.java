...
public class Main {
	public static void main(String args[])   {
		...
		int cont = 0;
		// Nesse laço captado o nome do jogador e a cor que cada um deseja utilizar, verificando se nenhum outro jogador escolheu a 
		//mesma cor anteriormente
		while(true) {
		...
		Tabuleiro tabuleiro = new Tabuleiro(); // Criando um novo Tabuleiro para iniciar o jogo
		...
		while(true) {
			...
			// Nesse laço é identificado ação que cada jogador deseja realizar
			if(comando.toUpperCase().startsWith("SA")) {
				...
				//Nesse caso ao selecionar Jogar ele ira chamar os dados e depedendo do resultado ira antar a quantidade 
				//de casas de acordo com a soma dos dados, logo apois é verificado em que tipo de casa o jogador parou, lançando as opções de 
				//ações disponiveis para cada tipo de casa no tabuleiro diferente.
