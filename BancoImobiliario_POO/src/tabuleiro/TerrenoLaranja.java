...
public class TerrenoLaranja extends Terreno implements CasaTabuleiro{

	public TerrenoLaranja(String nome, double preco, double valorAluguelSemCasa, double valorAluguelCom1Casa,
