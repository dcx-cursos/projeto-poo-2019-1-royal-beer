...
public class TerrenoRosa extends Terreno implements CasaTabuleiro{

	public TerrenoRosa(String nome, double preco, double valorAluguelSemCasa, double valorAluguelCom1Casa,
