...
public class TerrenoVerde extends Terreno implements CasaTabuleiro{

	public TerrenoVerde(String nome, double preco, double valorAluguelSemCasa, double valorAluguelCom1Casa,
